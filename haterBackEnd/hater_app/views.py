...
def pass_hate_filter(hate):
    ...
    slurs = ["faggot", "Faggot", "faggots", "Faggots", "kys", "kill your self", "Kill your self",
             "Nigger", "nigger", "nigga", "Nigga", "Niggers", "niggers", "niggas", "Niggas", "fag", "Fag", "Fags", "fags", "FAG", "fAg", "faG"]
        ...
        try:
            if not request.query_params:
                ...
                hates = Hates.objects.filter(
                    haters=request.query_params['haterid']).order_by('-hate_date')
    ...
    def post(self, request, format=None):
        try:
            ...
            if isAuthenticated:
                ...
                new_hate = Criticism.objects.create(
                    c_body=content, hater=hater, hate=hate_instance)
                new_hate.save()
    ...
    def post(self, request, format=None):
        try:
            ...
            if isAuthenticated:
                ...
                Hates.objects.create(
                    haters=hater, h_body=h_body, hate_count=0, rehate_count=0, crit_count=0)
                return Response({'message': " ◕‿↼ Updated ! "})
            else:
